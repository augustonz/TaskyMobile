...
import {Container, Label, Row, SubmitButton, SubmitButtonCancel, Text} from './styles';
...
export default function UpdateTask({task, select}) {
  ...
  return (
    <Container>
      ...
      <Row>
        <SubmitButtonCancel onPress={cancelUpdate}><Text>Cancelar</Text></SubmitButtonCancel>
        <SubmitButton onPress={handleSubmit}><Text>Confirmar</Text></SubmitButton>
      </Row>
    </Container>
  );
}
